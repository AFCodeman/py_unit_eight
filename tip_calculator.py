...
numb_diners1 = tk.Radiobutton(root, text="1", value=1, variable=people)
numb_diners1.grid(row=5, column=1)
numb_diners2 = tk.Radiobutton(root, text="2", value=2, variable=people)
numb_diners2.grid(row=5, column=2)
numb_diners3 = tk.Radiobutton(root, text="3", value=3, variable=people)
numb_diners3.grid(row=5, column=3)
numb_diners4 = tk.Radiobutton(root, text="4", value=4, variable=people)
numb_diners4.grid(row=5, column=4)
numb_diners5 = tk.Radiobutton(root, text="5", value=5, variable=people)
